...
//  (Front-end developer)
console.log(`'Hi this is easter egg!'`);
// Const у которого все находится внутри будет нашей function под названием -(newFunction_while)
const { footer_input, navbar, hamburger_menu, links, filter_btns, skills_wrap, skills_bars, records_wrap, records_numbers } = newFunction_while(); // Function with global
